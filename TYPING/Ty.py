...
class TypingSpeedTest:
    ...
    def create_widgets(self):
        ...
        self.login_button = tk.Button(self.options_bar, text="Sign Up", command=self.show_login_window, bg="#1a1a1a", fg="white", relief="flat", padx=10, font=("Helvetica", 12, "bold"))
        self.login_button.pack(side="right", padx=10)
        self.signup_button = tk.Button(self.options_bar, text="Login", command=self.show_signup_window, bg="#1a1a1a", fg="white", relief="flat", padx=10, font=("Helvetica", 12, "bold"))
